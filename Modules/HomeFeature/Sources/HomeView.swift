...
public struct HomeView: View {
    ...
    Those two kinds of complexity are represented with asymptotic notations, mainly with the symbols O, \u{398}, and \u{3A9}, which represent the upper bound, the tight bound, and the lower bound of an algorithm's complexity. The numeric value of these bounds is specified in parentheses in terms of the number *n*, which is the number of elements in the data structure.
