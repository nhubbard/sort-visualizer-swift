...
/// renderer directly; that's now `SortAudioCore.LocalToneEventSink`'s job instead (see
/// Documentation/docs/architecture/audio.md) — a `LocalToneEventSink` wraps the *same* `ToneRenderer` a caller hands to this type,
...
public final class ToneVoice: Node {
  ...
  /// `maximumFramesToRender` — the more precise source of truth Documentation/docs/architecture/audio.md calls for
