// GENERATED by Tools/GenerateThemes/generate_themes.py from Pygments' own "algol_nu" style —
// do not hand-edit. Re-run the script (see its module docstring) to refresh after a Pygments
// version bump instead.
import SwiftUI

public struct AlgolNuTheme: CodeTheme {
  public init() {}
  ...
  public var styles: [CodeAttributes.Value: TextFormat] {
    [
      ...
      .keywordDeclaration: TextFormat(fg: Color(rgba: Self.hex000000), bg: Color(rgba: Self.hexffffff), bold: true, italic: true),
