    ...
    public static var appShortcuts: [AppShortcut] {
        AppShortcut(
            intent: RunAutomationIntent(
                automation: AutomationEntity(id: "sizeSweep", displayName: "Size Sweep", iconName: "arrow.up.right")),
            phrases: [
        ...
        AppShortcut(
            intent: RunAutomationIntent(
                automation: AutomationEntity(id: "maxSizeOnly", displayName: "Max Size Only", iconName: "arrow.up.to.line")),
            phrases: [
