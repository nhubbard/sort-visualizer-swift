...
public struct RunSortIntent: AppIntent {
  ...
  @Parameter(
    title: "Algorithm",
    description: "The algorithm to run, selected exactly as if tapped in the sidebar.")
  public var algorithm: AlgorithmEntity
  @Parameter(
    title: "Visualizer", description: "Defaults to whichever visualizer is already selected.")
  ...
  @Parameter(
    title: "Array Size",
    description:
      "Defaults to the app's configured default size, clamped to the algorithm's own range.")
  public var size: Int?
  ...
  public init(
    algorithm: AlgorithmEntity, visualizer: VisualizerEntity? = nil, shuffle: ShuffleEntity? = nil,
    size: Int? = nil
  ) {
