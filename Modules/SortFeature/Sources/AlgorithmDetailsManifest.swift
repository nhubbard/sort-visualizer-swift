...
/// The inner `ADTL` manifest (Documentation/docs/reference/compression.md's
/// "Inner payload header"/"Algorithm directory records"/"Content entries" tables), parsed from the
