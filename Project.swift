...
let modules: [Target] =
    ...
    // C/C++ interop. See Documentation/docs/reference/compression.md for why. Test fixtures are
    ...
    // SortFeature. See Documentation/docs/architecture/audio.md.
    ...
    // The AUv3 instrument (see Documentation/docs/architecture/audio.md): the AUAudioUnit subclass +
...
let app = Target.target(
    ...
    dependencies: [
        ...
        // mechanism needed. Mac Catalyst only, permanently (see Documentation/docs/architecture/audio.md's
