...
This leaves 196 candidates. 176 are shipped. 20 remain, in one category.
...
| Hybrid (41) | 21 ported, 20 remaining |
...
- `DropMergeSort`, `OptimizedWeaveMergeSort`, `ImprovedBlockSelectionSort`.
