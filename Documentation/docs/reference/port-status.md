...
This leaves 196 candidates. 185 are shipped. 11 remain, in one category.
...
| Hybrid (41) | 30 ported, 11 remaining |
...
- `FifthMergeSort`, `BufferPartitionMergeSort`, `OptimizedRotateMergeSort`, `EctaSort`.
