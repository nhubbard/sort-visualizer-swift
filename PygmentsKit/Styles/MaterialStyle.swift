    ...
    TextFormat.getBuilder(bg: backgroundColor).then { it in
      switch tokenType {
        ...
        case .nameBuiltin, .nameDecorator, .nameFunction, .nameFunctionMagic, .nameLabel, .nameVariableMagic:
          it.fg(0x82aaff)
        case .escape, .keywordConstant, .keywordPseudo, .nameBuiltinPseudo, .nameEntity, .nameVariable,
             .nameVariableClass, .nameVariableGlobal, .nameVariableInstance, .stringInterpol, .stringRegex,
             .stringSymbol, .operator, .punctuation, .genericEmph, .genericSubheading:
          it.fg(0x89ddff)
        case .keyword, .keywordDeclaration, .keywordType, .nameAttribute, .stringAffix:
          it.fg(0xbb80b3)
        case .literal, .literalDate, .string, .stringBacktick, .stringChar, .stringDouble, .stringHeredoc, .stringOther,
             .stringSingle, .genericHeading, .genericInserted:
          it.fg(0xc3e88d)
        ...
        case .nameClass, .nameException, .nameProperty, .nameNamespace, .genericPrompt:
          it.fg(0xffcb6b)
        case .stringDoc, .comment, .commentPreproc, .commentPreprocFile, .commentSingle, .commentSpecial,
