...
struct Sort2App: App {
  init() {
    ...
    AlgorithmRegistry.shared.builtIns = [
      ...
      DualPivotQuickSort(), ExchangeBogoSort(), FlashSort(), FlippedMinHeapSort(), FluxSort(), FoldSort(),
      ForcedStableQuickSort(), FunSort(), GnomeSort(), GrailSort(), GravitySort(), GuessSort(), HanoiSort(),
      HybridCombSort(), ImprovedInPlaceMergeSort(), IndexSort(), InPlaceLSDRadixSort(), InPlaceMergeSort(),
      ...
      MatrixSort(), MaxHeapSort(), MedianQuickBogoSort(), MergeBogoSort(), MergeExchangeSortIterative(),
      MergeInsertionSort(), MergeSort(), MinHeapSort(), MinMaxHeapSort(), MSDRadixSort(), NewShuffleMergeSort(),
      OddEvenMergeSortIterative(), OddEvenMergeSortRecursive(), OddEvenSort(), OptimizedBubbleSort(),
      OptimizedCocktailShakerSort(), OptimizedDualPivotQuickSort(), OptimizedGnomeSort(), OptimizedGuessSort(),
      OptimizedLazyStableSort(), OptimizedStoogeSort(), OptimizedStoogeSortStudio(), OutOfPlaceHeapSort(),
      ...
      PigeonholeSort(), PoplarHeapSort(), QuadSort(), QuadStoogeSort(), QuickBogoSort(), QuickSort(), RandomGuessSort(),
      ...
      StableSelectionSort(), StacklessAmericanFlagSort(), StacklessBinaryQuickSort(), StacklessRotateMergeSort(),
