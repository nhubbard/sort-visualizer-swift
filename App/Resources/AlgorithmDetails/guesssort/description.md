...
Unlike its two descendants, this version does not stop after finding a valid guess. It continues incrementing the
odometer all the way through the entire nⁿ space, remembering only the *last* valid guess it happened to pass along
