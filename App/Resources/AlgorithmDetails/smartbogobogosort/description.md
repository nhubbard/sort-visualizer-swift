...
It's a deliberately wasteful way to use that observation: rather than simply moving the last element into place once the
...
same bet at a smaller scale, which is what gives this family its name — a nod to the even more extravagantly wasteful
Bogobogosort it's a tamer cousin of.
