...
Building this structure one element at a time follows ordinary heap construction: each new element either starts
...
one it does not need to disturb. On data that is already sorted or nearly so, that early stop happens almost
