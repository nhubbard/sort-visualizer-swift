...
This iterative formulation replaces recursive halving of the array with three nested loops over strictly shrinking
window sizes, called the gap. For each gap, a window of that size slides across the array, and within each window a pair
of pointers folds inward from its two edges toward its center, comparing and swapping as they go. Because the number of
