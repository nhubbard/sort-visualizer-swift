...
and swaps the elements they hold, but only when that particular swap would fix a genuine inversion between the
...
inversion is found and fixed, the number of iterations Exchange Bogo Sort needs is a open-ended random
