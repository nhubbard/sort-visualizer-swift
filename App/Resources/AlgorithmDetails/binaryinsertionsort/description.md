...
element moves remains O(n²) in the worst case, as with ordinary insertion sort.
...
Because comparisons are relatively cheap for primitive types but expensive for structured objects, Binary Insertion Sort is
