...
function searchAscending(arr, start, end, valueIndex) {
  var top = end - start;
  while (top > 1) {
    var mid = Math.floor(top / 2);
...
function searchDescending(arr, start, end, valueIndex) {
  var top = end - start;
  while (top > 1) {
    var mid = Math.floor(top / 2);
