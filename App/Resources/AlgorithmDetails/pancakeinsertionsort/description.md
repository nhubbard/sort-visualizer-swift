Pancake Insertion Sort is an insertion-sort variant that moves elements by reversing array prefixes.
...
The algorithm keeps insertion sort's overall structure, growing a sorted prefix and folding the next
element into it, but replaces every shift with a whole-prefix reversal, the same "flip"
...
Pancake Insertion Sort never shifts a single element. Every rearrangement, regardless of
...
O(n²) on average and in the worst case, since a long run of insertions near the front of a large,
