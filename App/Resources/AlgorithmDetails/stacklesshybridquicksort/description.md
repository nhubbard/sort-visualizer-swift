...
segment, swapping it in does not disturb the ordering the algorithm is building. It gives the
...
Once a segment is fully sorted, the algorithm does not recurse into the next segment. It
...
exhausting a call stack, no matter how it is fed.
