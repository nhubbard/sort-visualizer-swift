Optimized Stooge Sort (the "Studio" version, named for ArrayV's own distinction from the similarly
...
just a constant-factor tweak. It's credited in ArrayV to EilrahcF's original concept, aphitorite's
...
Unlike most of the other ArrayV "impractical" and exchange-family sorts covered here, this one is
explicitly documented — in ArrayV's own source comment — as a *stable* sort. That claim is taken
