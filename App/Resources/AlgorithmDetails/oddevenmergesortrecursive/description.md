Recursive Odd–Even Merge Sort is a recursive implementation of the odd–even
...
The algorithm expresses the network directly: the input is
...
of order by the split. Sorting the two halves and merging them together in this divide-and-conquer fashion follows the
...
Grochowski, differs from the textbook version of Batcher's network in one respect: the classic construction
