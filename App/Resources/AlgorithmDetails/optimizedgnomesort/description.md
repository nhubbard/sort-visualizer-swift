...
walks backward through the prefix it is currently placing, never back out into the part of the array it has not reached
yet.
...
shift the new element left until it is in place" step, just expressed as a chain of adjacent swaps instead of a single
shift.
...
backward swaps), degrading to O(n²) comparisons and swaps on random or reverse-sorted input.
