...
Two versions of this algorithm exist: a deterministic version that enumerates all permutations until it hits a sorted
one, and a [randomized](https://en.wikipedia.org/wiki/Randomized_algorithm) version that randomly permutes its input. An
