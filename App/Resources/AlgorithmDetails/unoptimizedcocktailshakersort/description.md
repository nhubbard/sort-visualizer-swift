Unoptimized Cocktail Shaker Sort is a fixed-pass variant of
...
value to the beginning. The unoptimized variant
...
forward-and-backward pass makes none. This gives it a best-case running time of O(n) on already-sorted input. A
...
Best case, average case, and worst case are therefore all O(n²), a strictly worse best case than either the plain or
