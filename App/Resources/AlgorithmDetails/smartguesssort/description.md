...
The effect is that it skips over large stretches of the nⁿ guess space that share an already-broken prefix, without
ever changing what counts as a valid final answer. It is still exploring the same enormous space Optimized Guess Sort
