...
Merge sort is a [divide-and-conquer algorithm](https://en.wikipedia.org/wiki/Divide-and-conquer_algorithm) that was
invented by [John von Neumann](https://en.wikipedia.org/wiki/John_von_Neumann) in 1945.

A detailed description and analysis of bottom-up merge sort appeared in a report
by [Herman Goldstine](https://en.wikipedia.org/wiki/Herman_Goldstine) and von Neumann as early as 1948.
