...
Building the heap and repeatedly extracting its root works as it does for a binary heap: sift the
...
trade off against each other rather than one straightforwardly beating the other. It is the same idea Base-N Max Heap
