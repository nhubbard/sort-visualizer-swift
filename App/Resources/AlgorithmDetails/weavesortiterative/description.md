...
above the real array's length. An array's length is rarely an exact power of two, and every
comparator whose target index would fall past the end of the real array is skipped. This is a common
...
level, weaving together comparator pairs at growing strides. This interleaving gives the algorithm its name.
